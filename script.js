...
function loadGameState(){
    ...
    const upgradeCount = localStorage.getItem('upgradeCount');
    const upgradeCost = localStorage.getItem('upgradeCost');
    const cookiesPerSecond = localStorage.getItem('cookiesPerSecond');
